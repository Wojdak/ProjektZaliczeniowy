    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Matches",
                columns: new[] { "Id", "date", "guest_team", "host_team", "price", "tickets" },
                values: new object[,]
                {
                    { 1, new DateTime(2022, 12, 26, 17, 30, 0, 0, DateTimeKind.Unspecified), 4, 2, 50, 15 },
                    { 2, new DateTime(2022, 12, 28, 21, 0, 0, 0, DateTimeKind.Unspecified), 1, 3, 40, 0 },
                    { 3, new DateTime(2022, 12, 31, 13, 30, 0, 0, DateTimeKind.Unspecified), 3, 4, 50, 5 },
                    { 4, new DateTime(2023, 1, 2, 20, 45, 0, 0, DateTimeKind.Unspecified), 2, 1, 45, 2 }
                });

            migrationBuilder.InsertData(
                table: "Teams",
                columns: new[] { "Id", "city", "country", "MatchId", "name", "stadium" },
                values: new object[,]
                {
                    { 1, "Manchester", "England", null, "Manchester City", "Etihad Stadium" },
                    { 2, "London", "England", null, "Arsenal", "Emirates Stadium" },
                    { 3, "Liverpool", "England", null, "Liverpool FC", "Anfield Stadium" },
                    { 4, "London", "England", null, "Chelsea", "Stamford Bridge Stadium" }
                });
